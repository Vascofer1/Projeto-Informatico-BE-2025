  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="p-10 bg-gray-100 min-h-screen flex justify-center">
      <div class="bg-white p-10 rounded-lg shadow-xl w-full max-w-5xl">
        ...
        <h3 class="mt-2 font-bold">Type</h3>
        ...
        <h3 class="mt-5 font-bold">Category</h3>
        <div class="flex space-x-2">
          <div class="relative w-1/2">
        ...
        <h3 class="mt-4 font-bold">End Date and Time</h3>
        <div class="flex space-x-2">
        ...
        <h3 class="mt-5 font-bold">Event Image</h3>
        <input type="file" @change="(e: any) => (form.image = e.target.files[0])"
          accept="image/png, image/jpeg, image/jpg" class="w-full p-2 border rounded bg-white" />
        <p class="text-gray-600 text-sm">Accepted formats: PNG, JPG, JPEG</p>


        <h3 class="mt-5 font-bold">Participant Limit</h3>
        <input v-model="form.limit_participants" type="number" placeholder="Quantity" class="w-full p-2 border rounded"
          min="1" />
